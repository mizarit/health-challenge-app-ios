...
static NSString * const kTakePhotoKey = @"Maak een foto";
static NSString * const kTakeVideoKey = @"Maak een video";
static NSString * const kChooseFromLibraryKey = @"Kies uit bibliotheek";
static NSString * const kChooseFromPhotoRollKey = @"Kies uit fotorol";
static NSString * const kCancelKey = @"Annuleren";
static NSString * const kNoSourcesKey = @"Geen bronnen";
...
- (void)actionSheet:(UIActionSheet *)actionSheet didDismissWithButtonIndex:(NSInteger)buttonIndex
{
    ...
    if (buttonIndex == self.actionSheet.cancelButtonIndex) {
        ...
        if (UI_USER_INTERFACE_IDIOM() == UIUserInterfaceIdiomPad) {
            ...
            [[self presentingViewController] presentViewController:self.imagePicker animated:YES completion:NULL];
        }
    }
}
